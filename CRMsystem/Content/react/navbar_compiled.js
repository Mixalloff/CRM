var Navbar = React.createClass({displayName: "Navbar",
	render: function() {
		return(
			...
			React.createElement("li", { className: "desktop col-md-1" }, React.createElement("a", { href: "../MainPage/Index" }, React.createElement("i", { className: "fa fa-desktop" }),
			"Рабочий стол")), 
			React.createElement("li", { className: "col-md-1" }, " ", React.createElement("a", { href: "../Deals/Index" }, React.createElement("i", { className: "fa fa-usd" }), "Сделки")),
			React.createElement("li", { className: "col-md-1" }, " ", React.createElement("a", { href: "../Contacts/Index" }, React.createElement("i", { className: "fa fa-phone" }), "Контакты")),
			React.createElement("li", { className: "col-md-1" }, " ", React.createElement("a", { href: "../Tasks/Index" }, React.createElement("i", { className: "fa fa-calendar" }), "Задачи")),
			React.createElement("li", { className: "col-md-1" }, " ", React.createElement("a", { href: "../Analytics/Index" }, React.createElement("i", { className: "fa fa-bar-chart" }), "Аналитика")),
